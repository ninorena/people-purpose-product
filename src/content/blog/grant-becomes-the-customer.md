...
Earlier this year I wrote about [what job you're hiring AI to do](/blog/ai-as-helper/), and that post ended on what you do with the time AI hands back to you. I've been thinking since then about the other side of that exchange. Every product takes something from the person using it. What about the time you take?
...
1. How are you determining currency? You already charge. The question is what, and from whom, and whether you'd be comfortable telling them the price.
2. And how are you breaking out of grant funding as the only sustainable way to innovate? As long as the grant is the only customer being satisfied, the product will keep learning what the funder wants. The people you're serving are paying too. They just don't get a receipt.
